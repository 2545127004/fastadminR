...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-imgurl" data-rule="required" class="form-control" name="row[imgurl]" type="number">
        </div>
    </div>
    <div class="form-group">
