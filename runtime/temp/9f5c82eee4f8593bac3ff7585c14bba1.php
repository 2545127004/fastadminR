<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"D:\demo\fastadminR\public/../application/admin\view\general\crontab\edit.html";i:1604650594;s:61:"D:\demo\fastadminR\application\admin\view\layout\default.html";i:1588765311;s:58:"D:\demo\fastadminR\application\admin\view\common\meta.html";i:1588765311;s:60:"D:\demo\fastadminR\application\admin\view\common\script.html";i:1588765311;}*/ ?>
<!DOCTYPE html>
...
<form id="edit-form" class="form-horizontal form-ajax" role="form" data-toggle="validator" method="POST" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_select('row[type]', $typeList, $row['type'], ['class'=>'form-control', 'data-rule'=>'required']); ?>
        </div>
    </div>
    <div class="form-group">
...
+----------------------- min (0 - 59)</code></pre>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[status]', ['normal'=>__('Normal'), 'completed'=>__('Completed'), 'expired'=>__('Expired'), 'hidden'=>__('Hidden')], $row['status']); ?>
        </div>
    </div>
